...
describe PuppetX::Gpo::Paths do
    ...
    context 'when calling valid_paths several times' do
        it 'should read file once' do
            ...
            PuppetX::Gpo::Paths.new.valid_paths
            PuppetX::Gpo::Paths.new.valid_paths
        end
    end
end
